...
const RegisterPage=() =>{
  ...
  return (
    ...
    <div class="pl-16 pt-10">
        ...
        <input class="w-full p-3 pl-4 border border-black rounded-md text-xs" type='text'
         value={name} onChange={(e)=>setName(e.target.value)}  placeholder='Enter your Name' />
        </div>
        Phone Number
        <div class="w-full pt-1 pb-2">
        <input class="w-full p-3 pl-4 border border-black rounded-md text-xs" type="tel"
         value={phonenumber} onChange={(e)=>setPhonenumber(e.target.value)} placeholder='Enter your phone number'/>
        </div>
        Email<br />
        <div class="w-full pt-1 pb-2">
        <input class="w-full p-3 pl-4 border border-black rounded-md text-xs" type='email'
        ...
        <button class="bg-[#946CC3] text-white w-80 p-2.5 mb-2 rounded-md" onClick={signUp}>Sign In</button>
        </div>
